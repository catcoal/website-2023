...
// 获取文章列表
export function FetchPostList(params:PostListRequest):Promise<IResultData<PostListResponse>> {
    return Request.post('/post/list',params);
}

// 获取文章详情
export function FetchPostDetail(id:Number):Promise<IResultData<PostDetail>> {
    return Request.post('/post/detail', {
        id
    })
}
...
export function FetchPostRandomList():Promise<IResultData<PostListResponse>> {
    return Request.post('/post/random')
}

// 获取推荐文章列表
export function FetchPostRecommendList():Promise<IResultData<PostListResponse>> {
    return Request.post('/post/recommend')
}
