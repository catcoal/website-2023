...
import colorPlaceholder from "~/assets/icons/color-placeholder.svg"
...
renderer.renderer.rules.image = (tokens, idx, options, env, self) => {
  ...
  return `<img src="${colorPlaceholder}" data-src="${newUrl}" alt="博客详情页图${idx}" class="lazyload" loading="lazy"/>`;
};
// 渲染文章
